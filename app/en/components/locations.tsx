...
const location = {
  name: "Location in Puebla",
  address: "Exact location in Puebla, Mexico",
  phone: "55 1555 0994",
    ...
    <section className="w-full bg-white py-16 lg:py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-light text-gray-900">Our Location</h2>
          <p className="text-lg text-gray-600">Consult at our office in Puebla</p>
        </div>
